...
define(function (require) {
    ...
    Effects.scrollCircular = function (panelInfo) {
        ...
        if (fromIndex > -1) {
            ...
            var isBackward = this._isBackward === undefined
                ? toIndex < fromIndex : this._isBackward;
            ...
            var isCritical = (isBackward && isBackwardCritical)
                || (!isBackward && isForwardCritical);
    ...
    function resetPosition(isBackward, prop, viewDiff) {
        ...
        // 瞬移到正常位置
        container.css(prop, isBackward ? -viewDiff * (len - 1) : '');
    }
